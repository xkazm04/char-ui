...
export const ProgressBarTexted = () => {
    return <>
        <motion.div
            ...
            className="px-4 py-3 bg-gradient-to-r from-sky-900/20 to-purple-900/20 border-b border-sky-900/20"
        >
            <div className="flex items-center gap-3">
                <div className="w-5 h-5 border-2 border-sky-400 rounded-full animate-spin border-t-transparent"></div>
                <span className="text-sm text-sky-300">Generating your masterpiece...</span>
